...
<head>
  ...
  <title><?php echo $controller_name; ?></title>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown notifications-menu btn-notif" data-target-url="<?php echo $controller.'/click_notif' ?>" data-target-id="<?php echo $this->session->userdata['member']['id']; ?>">
                  ...
                  <?php 
                    ...
                    <li>
                      <a <?php if($row->sent_status == 0) echo 'style="background-color: #f4f4f4"'; ?>>
                        <div class="pull-left">
                          <i class="fa fa-shopping-cart <?php if($row->type == 2) { echo 'text-orange'; } else echo 'text-green'; ?>"></i> <?php if($row->type == 2) { echo 'your lend '.$row->lend_id.' request has approved'; } else { echo 'your lend '.$row->lend_id.' has confirmed return'; } ?>
                        </div> <br>
                        <h4>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <!-- </div> -->
        <div class="col-xs-12">
          <b style="color: white;"><?php echo $this->session->userdata['member']['name']; ?></b>
        </div>
      </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li <?php if($this->uri->segment(1) == 'home') echo 'class="active"' ?>>
          <a href="home"><i class="fa fa-dashboard"></i> 
            <span>Dashboard</span>
            <?php if($total_lend_late != 0 ) { ?>
            <span class="pull-right-container">
              <small class="label pull-right bg-red"><?php echo $total_lend_late; ?></small>
            </span>
            <?php } ?>
          </a>
        </li>
        <li <?php if($this->uri->segment(1) == 'profile') echo 'class="active"' ?>><a href="profile"><i class="fa fa-user"></i> <span>Profile</span></a></li>
        <li <?php if($this->uri->segment(1) == 'change_password') echo 'class="active"' ?>><a href="change_password"><i class="fa fa-lock"></i> <span>Change Password</span></a></li>
        <li <?php if($this->uri->segment(1) == 'lend') echo 'class="active"' ?>><a href="lend"><i class="fa fa-shopping-bag"></i> <span>Lends</span></a></li>
        <li class="header"><p></p></li>
        <li <?php if($this->uri->segment(1) == 'logs') echo 'class="active"' ?>><a href="logs"><i class="fa fa-file"></i> <span>Logs</span></a></li>
        <li><a href="home/logout"><i class="fa fa-sign-out"></i> <span>Logout</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
